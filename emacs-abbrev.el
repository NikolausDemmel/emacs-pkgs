(define-abbrev-table 'global-abbrev-table 
  '(
    ...
    ;; email
    ("twdy" "wordy-engl...@yahoogroups.com" nil 0)
    ...
    ("timf" "find . -name \"*png\" | xargs -l -i basename \"{}\" \".png
\" | xargs -l -i  convert -quality 85% \"{}.png\" \"{}.jpg\"" nil 0)
    ...
    ("tunison" "unison -servercmd /usr/bin/unison c:/Users/xah/web
ssh://...@example.com//Users/xah/web" nil 0)
    ("tsftp" "sftp x...@xahlee.org" nil 0)
    ("tssh" "ssh x...@xahlee.org" nil 0)
    ("trsync" "rsync -z -r -v -t --exclude=\"*~\" --exclude=\".DS_Store
...
x...@example.com:~/" nil 0)
    ...
    ("trsync2" "rsync -r -v -t --delete --rsh=\"ssh -l xah\" ~/web/
x...@example.com:~/web/" nil 0)
    ("trsync3" "rsync -r -v -t --delete --exclude=\"**/My *\" --rsh=
